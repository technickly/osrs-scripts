...
def cast():
    ...
    pg.moveTo(deposit_string[0]+random.randint(-2,2),deposit_string[1]+random.randint(-5,5),.2+random.random()/2,pg.easeInQuad)
    pg.click()
    ...
    for i in range(5):
        ...
        pg.moveTo(cast_spell[0]+random.randint(-2,2),cast_spell[1]+random.randint(-5,5),.2+random.random()/2,pg.easeInQuad)
        pg.click()
