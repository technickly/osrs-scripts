...
def smith():
    ...
    pg.moveTo(deposit_all[0]+random.randint(-2,2),deposit_all[1]+random.randint(-5,5),.2+random.random()/2,pg.easeInQuad)
    pg.click()
    ...
    # pg.press('space')
    #if gold
    time.sleep(30.5+random.random()/10)
